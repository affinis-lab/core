...
def decode_netout(max_obj, netout, anchors, nb_class, obj_threshold=0.3, nms_threshold=0.3):
...
def fun(max_obj, res, anchors, num_classes, obj_threshold, nms_threshold):
