...
def get_postprocessing_fun(max_obj, anchors, num_classes, obj_threshold, nms_threshold):
    return lambda res: postprocessing.fun(max_obj, res, anchors, num_classes, obj_threshold, nms_threshold)
